...
namespace GameFramework.Module.Setting
{
    ...
    /// PlayerPrefs 游戏配置辅助器。
    /// </summary>
    public class SettingHelperPlayerPrefs : SettingHelperBase
    {
        /// <summary>
        /// 获取游戏配置项数量。
        /// </summary>
        ...
        {
            return JsonUtility.FromJson<T>(GetString(settingName));
        }
        ...
        {
            return JsonUtility.FromJson(GetString(settingName), objectType);
        }
