...
namespace GameFramework.Module.Collections
{
    /// <summary>
    /// 游戏框架多值字典类。
    /// </summary>
    ...
    public sealed class SortedDictionaryMultiValue<TKey, TValue> : IEnumerable<KeyValuePair<TKey, LinkedListRange<TValue>>>
    {
        private readonly LinkedListCached<TValue> _linkedListCached;
        private readonly SortedDictionary<TKey, LinkedListRange<TValue>> _dictionary;

        /// <summary>
        /// 初始化游戏框架多值字典类的新实例。
        /// </summary>
        public SortedDictionaryMultiValue()
        {
            _linkedListCached = new LinkedListCached<TValue>();
            _dictionary = new SortedDictionary<TKey, LinkedListRange<TValue>>();
        }
        ...
        {
            private SortedDictionary<TKey, LinkedListRange<TValue>>.Enumerator _enumerator;

            internal Enumerator(SortedDictionary<TKey, LinkedListRange<TValue>> dictionary)
            {
                if (dictionary == null)
                {
