...
namespace GameFramework.Module.Log
{
    /// <summary>
    /// 日志脚本宏定义。
    /// </summary>
    public static class LogScriptingDefineSymbols
    {
        ...
        /// 禁用所有日志脚本宏定义。
        /// </summary>
        [MenuItem("框架/日志脚本宏定义/禁用所有日志输出", false, 0)]
        ...
        /// 开启所有日志脚本宏定义。
        /// </summary>
        [MenuItem("框架/日志脚本宏定义/启用所有日志输出", false, 1)]
        ...
        /// 开启调试及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("框架/日志脚本宏定义/启用 Debug 级以上的日志输出", false, 2)]
        ...
        /// 开启信息及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("框架/日志脚本宏定义/启用 Info 级以上的日志输出", false, 3)]
        ...
        /// 开启警告及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("框架/日志脚本宏定义/启用 Warning 级以上的日志输出", false, 4)]
        ...
        /// 开启错误及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("框架/日志脚本宏定义/启用 Error 级以上的日志输出", false, 5)]
        ...
        /// 开启严重错误及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("框架/日志脚本宏定义/启用 Fatal 级以上的日志输出", false, 6)]
