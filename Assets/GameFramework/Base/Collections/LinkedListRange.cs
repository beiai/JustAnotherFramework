    ...
    public struct LinkedListRange<T> : IEnumerable<T>
    {
        ...
        public int Count
        {
            get
            {
                ...
                var count = 0;
                for (var current = _first; current != null && current != _terminal; current = current.Next)
                {
                    count++;
                }
        ...
        public struct Enumerator : IEnumerator<T>
        {
            ...
            internal Enumerator(LinkedListRange<T> linkedListRange)
            {
                ...
                _linkedListRange = linkedListRange;
            ...
            {
                if (_current == null || _current == _linkedListRange._terminal)
                {
                    return false;
                }
