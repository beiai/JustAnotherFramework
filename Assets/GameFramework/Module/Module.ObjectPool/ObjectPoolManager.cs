...
namespace GameFramework.Module.ObjectPool
{
    /// <summary>
    /// 对象池管理器。
    /// </summary>
    internal sealed class ObjectPoolManager : IModule, IObjectPoolManager
    {
        ...
        {
            return (IObjectPool<T>)InternalGetObjectPool(GetFullName(typeof(T), name));
        }
