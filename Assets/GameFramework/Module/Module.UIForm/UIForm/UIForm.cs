...
namespace GameFramework.Module.UIForm
{
    ...
    public sealed class UIForm : MonoBehaviour, IUIForm
    {
            ...
            bool isNewInstance, object userData)
        {
            ...
            {
                Log.Error($"UI form '[{_serialId}]{_uiFormAssetName}' OnInit with exception '{exception}'.");
            }
        }
        ...
        public void OnRecycle()
        {
            ...
            {
                Log.Error($"UI form '[{_serialId}]{_uiFormAssetName}' OnRecycle with exception '{exception}'.");
            }
        ...
        public void OnOpen(object userData)
        {
            ...
            {
                Log.Error("UI form '[{m_SerialId}]{m_UIFormAssetName}' OnOpen with exception '{exception}'.");
            }
        }
        ...
        public void OnClose(bool isShutdown, object userData)
        {
            ...
            {
                Log.Error("UI form '[{m_SerialId}]{m_UIFormAssetName}' OnClose with exception '{exception}'.");
            }
        }
        ...
        public void OnPause()
        {
            ...
            {
                Log.Error("UI form '[{m_SerialId}]{m_UIFormAssetName}' OnPause with exception '{exception}'.");
            }
        }
        ...
        public void OnResume()
        {
            ...
            {
                Log.Error("UI form '[{m_SerialId}]{m_UIFormAssetName}' OnResume with exception '{exception}'.");
            }
        }
        ...
        public void OnCover()
        {
            ...
            {
                Log.Error("UI form '[{m_SerialId}]{m_UIFormAssetName}' OnCover with exception '{exception}'.");
            }
        }
        ...
        public void OnReveal()
        {
            ...
            {
                Log.Error("UI form '[{m_SerialId}]{m_UIFormAssetName}' OnReveal with exception '{exception}'.");
            }
        }
        ...
        public void OnRefocus(object userData)
        {
            ...
            {
                Log.Error("UI form '[{m_SerialId}]{m_UIFormAssetName}' OnRefocus with exception '{exception}'.");
            }
        }
        ...
        public void OnUpdate()
        {
            ...
            {
                Log.Error($"UI form '[{_serialId}]{_uiFormAssetName}' OnUpdate with exception '{exception}'.");
            }
        }
